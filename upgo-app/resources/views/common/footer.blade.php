        ...
        <div class="module_container">
            <ul class="content_list row gutter">
                <li id="fitem_block_0" class="fitem_block_info item_block col-25 wow">
                    <h3 class="title">
                        <a href="">{{$footerInfo->brandTitle}}</a>
                    </h3>
                    <p class="description">{{$footerInfo->brandDesc}}</p>
                    <div class="shareicon">
                        <a class="fl" target="_blank"
                           href="{{$footerInfo->weiboLink}}">
                            <i class="fa fa-weibo"></i>
                        </a>
                        <a class="fl" target="_blank" href="{{$footerInfo->qqLink}}">
                            <i class="fa fa-qq"></i>
                        </a>
                        <a id="mpbtn" class="fl"
                           href="{{$footerInfo->weixiQrCodeLink}}">
                ...
                <li id="fitem_block_3" class="fitem_block_link item_block col-25 wow">
                    <ul>
                        ...
                        <li><a class="ellipsis" href="forum/post/79339/index.html" target="_blank">更多联系地址</a></li>
                    </ul>
                </li>
            </ul>
        </div>
